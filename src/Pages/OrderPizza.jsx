   ...
   <div className='FooterTotal'>
    <div className='FooterFirst'>
        <div className="FooterDiv">
            <ul className='flex justify-around flex-row-reverse gap-[30rem]'>
                <img className='bg-black' src="./images/twitter.svg" alt="" />
                <p>© 2023 Teknolojik Yemekler.</p>
            </ul>
        </div>
    </div>
    
    <div className='FooterSecond flex flex-row-reverse justify-around items-center'>
